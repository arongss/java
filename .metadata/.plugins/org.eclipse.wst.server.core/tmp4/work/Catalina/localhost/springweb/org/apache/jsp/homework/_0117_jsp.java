 ...
 * Generated at: 2023-01-18 02:17:40 UTC
...
public final class _0117_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		var tIdx = 4 // 정중앙 cel index\r\n");
      out.write("		$(\"td\").height(\"100pt\")\r\n");
      out.write("		$(\"td\").eq(tIdx).css(\"background\",\"pink\")\r\n");
      out.write("		$(\"td\").text(function(idx){\r\n");
      out.write("			$(this).css({fontSize:\"100px\"})\r\n");
      out.write("			return idx+1;\r\n");
      out.write("		})\r\n");
      out.write("		$(this).keyup(function(){\r\n");
      out.write("			$(\"td\").css(\"background\",\"\")\r\n");
      out.write("			// 화살표 왼쪽부터 시계방향으로 37,38,39,40\r\n");
      out.write("			// 좌 37, 우 39\r\n");
      out.write("			console.log(event.keyCode)\r\n");
      out.write("			if(event.keyCode==37) tIdx--\r\n");
      out.write("			if(event.keyCode==39) tIdx++\r\n");
      out.write("			// 상 38, 하 40\r\n");
      out.write("			// +=3,	  +=3\r\n");
      out.write("			if(event.keyCode==38) tIdx-=3\r\n");
      out.write("			if(event.keyCode==40) tIdx+=3\r\n");
      out.write("			$(\"td\").eq(tIdx).css(\"background\",\"pink\")\r\n");
      out.write("		})\r\n");
      out.write("	});\r\n");
      out.write("</script>\r\n");
      ...
      out.write("  <h2>테이블 eq연습</h2>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"container\" id=\"showList\">\r\n");
      out.write("	<table height=\"300pt\" class=\"table table-hover table-striped\">\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /homework/0117.jsp(7,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("path");
      // /homework/0117.jsp(7,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/homework/0117.jsp(7,0) '${pageContext.request.contextPath }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${pageContext.request.contextPath }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_fmt_005frequestEncoding_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /homework/0117.jsp(8,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
