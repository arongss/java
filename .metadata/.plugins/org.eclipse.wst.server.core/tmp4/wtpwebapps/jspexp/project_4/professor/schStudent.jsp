	...
	<body>
      ...
      <div>
         ...
         <div class="flex-box2">
			...
			<jsp:useBean id="sch" class="jspexp.project_4.vo.Lecture_p"/>
               ...
               <div class="main-box-flex">
                  <div id="main-box2">
                     ...
                     <table>
                         ...
                         <col width="16%"><col width="16%">
                         <thead>
                            <tr><th>강의번호</th><th>강의년도</th><th>학기</th><th>과목명</th><th>구분</th><th>성적관리</th></tr>
                         </thead>
                         <tbody>
                            ...
                            <tr>
								...
								<td>${std.lecName}</td>
								<td>${std.sort}</td>
								<td><a onclick="goPage(${std.lecNum})" class="stdSch"><span>수강생조회</span></a></td>
							</tr>
							</c:forEach>
                         </tbody>
                      </table>
