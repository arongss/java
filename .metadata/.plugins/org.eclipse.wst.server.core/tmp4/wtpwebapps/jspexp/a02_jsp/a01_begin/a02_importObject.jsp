...
ex) vo하위에 Product 물건명/가격/갯수 선언..
 ...
 --%>
<%
	Product pd = new Product("사과",3000,5);
%>
	<h3>물건 정보</h3>
	<table width="50%" border>
		<tr><th>물건명</th><td><%=pd.getPname() %></td></tr>
		<tr><th>가격</th><td><%=pd.getPrice() %></td></tr>
		<tr><th>갯수</th><td><%=pd.getCnt() %></td></tr>
		<tr><th>총계</th><td><%=pd.getPrice()*pd.getCnt() %></td></tr>
	</table>
</body>
</html>