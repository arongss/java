...
http://localhost:7080/a02_jsp/a01_begin/	
	a07_request.jsp?name=홍길동&num01=25&num02=30
ex) 요청키는 pname, price, cnt로 하고 물건명, 가격, 갯수를 query string으로
	전달하고,
 ...
 --%>
	...
	<h3><%=request.getParameter("cnt") %></h3>
	<h1>데이터 유형에 대한 확인</h1>
	<h3><%=request.getParameter("price")+request.getParameter("cnt") %></h3>
