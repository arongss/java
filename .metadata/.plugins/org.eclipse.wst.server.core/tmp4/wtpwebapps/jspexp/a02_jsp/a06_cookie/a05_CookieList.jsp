...
<%--
# 쿠키 수정하기
1. 기존에 쿠키의 키를 다른 값으로 할당하고, 다시 response 객체로 전달한다.
--%>
	<h2>현재 쿠키 리스트</h2>
	...
	<input type="button" value="쿠키추가" onclick="go('add')"/>
...
1. 파일 정보
	1) a05_CookieLies.jsp : 쿠키값 전체 리스트
...
2. 개발 순서
	...
	2) 요청값에 따른 쿠키데이터 처리(a09_proc.jsp)
		...
		response.sendRedirect("a05_CookieLies.jsp");
*/
