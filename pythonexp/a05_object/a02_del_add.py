...
#    되게 처리하여, 물건 객체 두개를 하나는 명시적 소멸자로
...
class Product:
    ...
    def __del__(self):
        ...
        self.name=None
        self.price=0
pr01 = Product("사과",3000)
pr02 = Product("바나나",4000)
pr03 = Product("오렌지",3200)
print("명시적 초기화"); del(pr01)
print("묵시적 초기화(라인마지막)");
'''
# __add__()메서드
1. 같은 유형의 객체기리 참조값으로
    덧셈연산을 처리하는 경우에 실행되는 메소드
    ex) p01 = Product()
        p02 = Product()
        p01 + p02
'''
class Rabbit:
    ...
    def __add__(self,other):
        print("Rabbit클래스의 "+self.kind+"와 "+
              other.kind+"가 친구가 되었습니다.")
r1 = Rabbit("빨강 머리 토끼")
r2 = Rabbit("곱슬 머리 토끼")
r1 + r2