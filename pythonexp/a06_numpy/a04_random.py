...
# ex) 5X5 크기로 랜덤 범위를 정하여 츨력하세요
print(np.random.normal(size=(5,5)))

np.random.seed(seed=100)
# seed가 100일 때..: seed를 정하면 한번 실행한 후는 해당 seed에 따라
# 동일한 랜덤 데이터가 나타난다.
...
2. np.random.randint(시작수, 마지막수+1, size=배열의 크기)
3. np.random.randint(시작수, 마지막수+1, size=(행,열)
'''
# 0부터 1까지 경우의 수 2 가지로 크기는 5개인 배열
