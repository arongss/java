...
name = "홍길동" # 변수 선언과 할당
age = 25
print("이름:",name,"나이:",age) # 다른 데이터유형은 ,로 출력이 가능하다
# ex) 물건명, 가격, 갯수를 선언하고 출력하세요
name = "사과"; price = 3000; cnt = 3
print("물건명:",name,", 가격:",price,", 갯수:",cnt)
# ,(콤마)는 한칸씩 띄워 처리가 된다. +는 데이터 유형이 동일할 때만 처리가 가능하다.
print("문장1", end=",")
print("문장2", end="\t")
print("문장3", end="\n")
print()
# print()는 기본적으로 줄바꿈을 포함한다. 다음 명령문과 이어줄 때는 end 속성을 통해서 다음 명령에
# 대한 처리 방식을 선언할 수 있다.
...
2. 기본적으로 정수형으로 형변환할 때, int() 함수가 필요
