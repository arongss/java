...
public class A04_VarBasic {
	...
	public static void main(String[] args) {
		...
		// 숫자형 변수 선언
		int num01; // num01이란 변수에 정수를 할당하겠다고 선언
		num01 = 30; //데이터 30을 할당..
		int num02 = 40; //num02를 선언과 할당.
		String name = "홍길동";
		// 문자열 : 문자의 배열
		// String이라는 문자열을 처리하는 데이터형(객체형)을
		// 선언하고 데이터를 할당
		// "" : 문자열을 할당할 때, 쌍따옴표를 이용해서 할당한다.
		// name이라는 변수에 홍길동이라는 문자열 데이터를 선언과
		// 할당 처리..
		...
		//    해 주어야한다.
		// 숫자형문자열의 숫자변환
		// 1. int num01 = Integer.parseInt("숫자형문자열")
		//	  ex) int num01 = Integer.parseInt("25")
		// 2. double num01 = Double.parseInt("숫자형문자열")
		//	  ex) double num01 = Double.parseInt("3.14")
