...
public class A08_File {
	...
	public static void main(String[] args) {
		...
		String path = "C:\\a01_javaexp\\workspace\\javaexp\\src\\javaexp\\a12_io\\a02_path";
		...
		boolean isFile() : 파일의 크기 리턴
		String[] list() : 리렉토리에 포함되 파일 및 서브디렉토리 목록 배열로 리턴
		File[] listFiles() : 디렉토리에 포함된 파일 및 서브 디렉토리 목록 전부를
							File배열로 리턴
