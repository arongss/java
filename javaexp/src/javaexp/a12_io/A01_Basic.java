...
public class A01_Basic {
	...
	public static void main(String[] args) {
		...
		데이터를 입력할 때, 사용되는 객체이다.
			...
			한 main()프로그램에 기능 메서드로 처리하면 같은 객체를
			바라보기 때문에 정상적인 작동을 할 수 없다.
			이런 여러가지 IO를 보완한 Scanner()는 이런 처리를 피할 수있지만
		...
		4. 입력 처리를 하는 InputStream!!
			...
			0/1 ==> 8개 ==> 문자 ==>문자열
					코드값 65 ==> 'A'
						 49 ==> '1'
			1) 주요 메서드
				read() : 문자(char) ==> byte code 값으로 연결되어
		...
		// 입력할 때, 데이터를 처리해줄 수 있는 객체.
		// cf) Console창에서 출력시 사용되는 객체 System.out
		/*
		입력된 글자 한자를 읽어와서 데이터를 할당하고 할당된 내용을 출력
		하는 IO(input output)는 첫 시작이 InputStream과 OutputStream
		이라고 할 수 있다.
