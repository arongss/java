...
public class A08_UserException {
	...
	1. 형식
		public class XXXException extends [Exception|RuntimeException]{
			...
			// 위 생성자로 넘긴 message내용을 getMessage()에서 처리되어 나타난다.
			public String getMessage(){
	...
	# 예외 정보(exception 클래스에 있는 재정의하는 메소드
	...
	public static void main(String[] args) {
		...
		// ex) 1~100반복문 수행 %5로 0일 때,
		//		User01Exception 처리
		for(int cnt=1;cnt<=100;cnt++) {
			try {
				if(cnt%5==0) {
					throw new User01Exception("번호:"+cnt+"### 카운트 예외발생@@@");
				}
