...
public class A03_Map {
	...
	public static void main(String[] args) {
		...
		// ex) 학생의 번호(문자열)와 점수(정수)를 설정한 Map를
		//		선언하여 학생 3명의 번호와 점수를 할당하되, 2번은
		//		중복하여 입력결과를 출력하세요.
		...
		stdMap.put(1, new StuPoint("신길동",70,81,90));
		stdMap.put(3, new StuPoint("마길동",80,85,90));
		stdMap.put(2, new StuPoint("오길동",85,85,90));
		/*
		Wrapper클래스의 경우, key값은 중복을 제거하고,
		데이터가 자동 정렬 된다.
		 * */
