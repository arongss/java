...
1. 부모 클래스의 상속 메소드를 동일한 이름으로 수정해서 자식 클래스에서
 	재정의하는 것이다.
2. 목적
	1) 동일한 이름이지만 여러 형태로 자식 클래스에서 기능적 처리를 하고자 할 때,
		활용된다.
...
class Company{
	...
	public void earnMoney() {
		System.out.println(this.name+" 돈을 번다");
	}
}
...
class PoliceMan extends Worker{
	...
	public void working() { // overrding은 1. 상위와 동일한 이름으로 메서드를 정의
		super.working(); 
