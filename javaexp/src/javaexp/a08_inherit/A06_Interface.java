...
// ex) 인터페이스 AttackWay attack()여러가지 공격형태를 선언할 수
//		있게 추상 메서드 선언.
//		상속 받은 클래스 RocketMissile 로켓미사일공격..
//					레이저공격...
//		Mz에 필드, 메서드, 추력메서드 처리..
interface AttackWay{
	void attack();
...
class Wing03 implements Wing{
	...
	public void fly() {
		// TODO Auto-generated method stub
		System.out.println("날개 3호를 통해서 우주를 누비다!");
	}
}
// 실제 객체 날개 1호 구현..
...
class Wing01 implements Wing{
	...
	public void fly() {
		// TODO Auto-generated method stub
		System.out.println("날개를 통해서 우리 동네를 나르다!");
	}
}
...
class Mz{
	...
	public void flying() {
		if(this.wing!=null) {
			...
			// 하위 실제 객체가 overriding한 내용을 처리한다.
		}else {
