...
public class A02_Super_This {
	...
	public static void main(String[] args) {
				...
				- 하위 객체는 상위객체으 생성자를 생성하면서 처리가된다.
					...
					cf) 자바는 모든 클래스가 상위/하위 상속관계로 설정.
						...
						for(Object ob:li2){
							...
							// 주소값/String은 문자열의 toString() 문자열자체를 가지고 있기
							// 때문에 그대로 문자열이 나온다.
						}
		...
		Daughter01 d1 = new Daughter01("떡뽁이");
		System.out.println(d1.getFavFood());
	}
	// ex) Mother 잘하는요리필드선언, 생성자할당, 잘하는요리return메서드	Daughter Mother상속 생성자호출할당
	//	Daughter생성..
}
class Mother01{
	private String favFood;
	public Mother01(String favFood){
