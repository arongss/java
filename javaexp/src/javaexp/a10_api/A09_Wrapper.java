...
public class A09_Wrapper {
	...
	public static void main(String[] args) {
		...
		/*
			...
			==> Boxing
			( 25 ) ==> 25
			포장을 벗겨내고, 순수한 데이터 자체로 저장(stack영역에만 메모리 사용)
			==> UnBoxing
		 * 
		...
		3. 박싱(Boxing)과 언박싱(Unboxing)
			...
			1) 박싱 : 기본 타입의 값을 포장(Wrapper)객체로 만드는 과정을 말한다.
				...
				cd) 클래스명.메서드() : static 메서드로 클래스 종속 메서드
		...
		//		Boxing으로 Integer, Boolean, Double에 할당하고 출력하세요.
		Integer obj10 = Integer.valueOf(args[0]);
		Boolean obj11 = Boolean.valueOf(args[1]);
		Double obj12 = Double.valueOf(args[2]);
		System.out.println("args[0]:"+obj10);
		System.out.println("args[1]:"+obj11);
		System.out.println("args[2]:"+obj12);
		int num13 = obj10;
