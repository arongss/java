...
public class A06_String {
	...
	public static void main(String[] args) {
		...
		/*
		ex) 메뉴는 사과, 바나나, 딸기입니다.
			선택한 과일을 입력하세요라고 Scanner 입력받아서
			indexOf()메서드를 확인하여 있으면 @@번째 과일입니다. 표시하고
		...
		4) 조건(if, switch)
			switch(입력받은 결과위치) 
			-1 : 주문한 메뉴가 없음.
			기타 해당하는 위치1: 1변째 과일 사과를 주문하였습니다.
			기타 해당하는 위치2: 2변째 과일 사과를 주문하였습니다.
			기타 해당하는 위치3: 3변째 과일 사과를 주문하였습니다.
