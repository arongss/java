...
public class A08_StringBuffer {
	...
	public static void main(String[] args) {
		...
		for(int idx=0;idx<100;idx++) {
			...
			// 반복문에 문자열 + 연산자를 쓰는 것은 메모리효율화에 위험하다.
		...
		4. 단일 쓰레드 환경 : StringBuilder 사용
			1초 사용자1가 모든 다 처리할 때까지 기다리고
			2초 사용자2..
			순서확보를 정확하게 할 수 있으나
			한번에 한 사용자만 사용하여, 비효율적으로 처리된다.
		...
		// ex) 배열로 가위/바위/보로 문자열로 선언하고, 반복문으로 1~100회 임의의 가위 바위 보를
