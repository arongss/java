...
public class A02_HashCode {
	...
	public static void main(String[] args) {
		...
		Person p03 = p01;
		System.out.println("p01.hasCode():"+p01.hashCode());
		System.out.println("p02.hasCode():"+p02.hashCode());
		System.out.println("p03.hasCode():"+p03.hashCode());
		// 주소값이 같을 때 확인..
		...
		//		hashCode를 재정의하여 값이 동일할 때 true로
		//		처리되게 하세요..
		Product pro1 = new Product("사과",3000);
		Product pro2 = new Product("바나나",4000);
		Product pro3 = new Product("바나나",4000);
		System.out.println(pro1.hashCode());
		System.out.println(pro2.hashCode());
		System.out.println(pro3.hashCode());
		System.out.println(pro2.hashCode()==pro3.hashCode());
	}
...
class Product{
	...
	// hashCode를 재정의 하여, 속성값이 같은지 여부를 check할 수 있게 
	// 리턴 처리..
	// 
	@Override
	public int hashCode() {
