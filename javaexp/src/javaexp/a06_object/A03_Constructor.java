...
public class A03_Constructor {
	...
	public static void main(String[] args) {
		...
		# 생성자
		1. 필드 초기화
			1) 초기값 없이 선언된 필드는 객체가 생성돌 때, 기본값으로 자동 설정할 수 있다.
			2) 다른 값으로 필드 초기화하는 방법
				- 필드 선언할 때, 초기값 설정한다.
				- 생성자의 매개값으로 초기값 설정한다.
				- 매개변수와 필드명 같은 경우 this사용한다.
		2. 생성자 기본 형식
...
class Company{
	...
	int empNum;
	int earMoney;
	Company(){} // 프로그래머가 생성자를 추가할 때, default 생성자는 더이상
