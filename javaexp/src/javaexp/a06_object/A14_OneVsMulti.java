...
public class A14_OneVsMulti {
	...
	public static void main(String[] args) {
		...
		list.add(new Member("goodMam","이철수",5000));
...
class ShoppingMall{
	...
	public void regMemAll(ArrayList<Member> mlist) {
//		this.mlist = list; 전체데이터 덮어씌우기
		this.mlist.addAll(mlist); // 기존에서 list 추가
		System.out.println(mlist.size()+"명 회원 추가");
	}
