...
//			객체가 생성된 후에 사용할 수 있는 객체 소속 멤버
		...
		*/
		...
		비유컨데 롯데월드타워도면으로 서울에, 부산에, 제주도에 빌딩을 짓는다고 가정하면
...
// ex) BankAccount 클래스를 선언하고, 필드로(계좌명, 계좌별잔액)-인스턴스변수, (모든계좌의총액)-static변수
//		를 선언하여 데이터를 확인하세요..
class BankAccount{
	String name;
	int rest;
