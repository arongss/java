...
public class A01_Begin {
	...
	public static void main(String[] args) {
		...
		Book b1 = new Book();
		Book b2 = new Book();
		Book b3 = new Book(); // 선언된 클래스로 부터 여러개의 객체를 만든다
		System.out.println(b1); // heap영역의 주소값을 가지고 있다.
		...
		4. 하나의 클래스로부터 여러개의 인스턴스를 만들수 있다.
			...
			위 Book 클래스를 통해 b1, b2, b3의 여러 객체를 생성하여 이름을 할당..
