...
public class A02_Field {
	...
	public static void main(String[] args) {
		...
		Bus b01 = new Bus();
		System.out.println("초기 최고 속도:"+b01.maxSpeed);
		b01.maxPerson = 35;
		b01.no = "8001";
		System.out.println("# 버스1의 정보 #");
		System.out.println("버스번호:"+b01.no);
		System.out.println("버스최대속도:"+b01.maxSpeed);
		System.out.println("버스최대인원:"+b01.maxPerson);
		Bus b02 = new Bus("M3001");
		b02.maxPerson = 40; b02.maxSpeed = 100;
		System.out.println("# 버스2의 정보 #");
		System.out.println("버스2:"+b02.no);
		System.out.println("버스최대속도:"+b02.maxSpeed);
		System.out.println("버스최대인원:"+b02.maxPerson);
		Bus b03 = new Bus("7880",150,39);
		System.out.println("# 버스3의 정보 #");
		System.out.println("버스3:"+b03.no);
		System.out.println("버스최대속도:"+b03.maxSpeed);
		System.out.println("버스최대인원:"+b03.maxPerson);
	}
...
class Computer01{ // 같은 패키지 내에서 동일한 이름의 클래스가 선언되면 에러 발생.
	String company;
	String cpu;
	int price;
	Computer01(){} // 클래스는 여러 유형의 생성자를 선언할 수 있다. - 매개변수가 다를 때..
