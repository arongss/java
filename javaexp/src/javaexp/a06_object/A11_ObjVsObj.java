...
class HPerson{
	...
	// public void buyPhone(String pname){} // hp.buyPhone("삼성폰"); String pname="삼성폰"
	public void buyPhone(HandPhone01 phone) {
		...
		// HandPhone01 hp01 = new HandPhone01("010-8888-555","아이폰")
		// hp.buyPhone( hp01 );
	...
	public void checkMyPocket() {
		...
		// 메서드를 호출하여 객체가 할당되지않는 초기 상태..
		// cf) 객체할당하는 기능메서드에서는 반드시 아래 조건 처리를
		//	하여야지 NullPointerException에러가 발생하지 않는다.
		if( phone== null ) { // 위 기능메서드(buyPhone)로 핸드폰이 할당되지 않음.
