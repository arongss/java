...
//		short num05 = num01 + 20;
		...
		// ex1) byte 형으로 구매한 사과의 갯수와 바나나의 갯수를
		//	   합산하여 특정한 데이터 유형에 할당하세요.
		byte appleCnt = 5;
		byte bananaCnt = 10;
		int fruitCnt = appleCnt+bananaCnt;
		// ex2) 소고기 600g을 정수로 선언하고, 7등분하여 출력하세요
		int meat = 600;
		int div = 7;
		...
		** 주의
		강제타입변환은 할당된 데이터를 기준으로 처리하는 것이
		아니라, 데이터를 할당한 유형이 무엇이냐에 따라 형변환
		처리 casting을 하여야 한다.
