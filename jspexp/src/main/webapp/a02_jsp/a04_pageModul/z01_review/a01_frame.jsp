...
2. 각 프레임간의 데이터 전송
	1) 클라이언트단의 BOM객체와 DOM객체간의 접근 방법
...
<h2>최상위 BOM</h2>
<a href="a04_sub03.jsp" target="frame01">프레임1의 페이지 변경</a>
<%-- <h2>프레임3</h2> --%>
<a href="a05_sub04.jsp" target="frame01">프레임2의 페이지 변경</a>
<a href="javascript:call03()">윈도우 객체 로딩</a><br>
<%-- <h2>프레임4</h2> --%>
<button type="button" onclick="call01()">프레임1 접근해서 타이틀 변경</button>
<button type="button" onclick="call02()">프레임2 접근해서 타이틀 변경</button>
