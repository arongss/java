...
1. if조건을 통해서 null인 경우
	...
	null 데이터인 경우로 처리된다.
	==> 한페이지에서 form 입력화면과 요청값을 전달할 결과 데이터 출력 화면이 
...
?sname=&kor=&eng=&math=
		: 입력하지 않고 submit 했을 때 - request.getParameter("sname").equals("")
		ps) 서버에 전송되기 전에 js단에서 form 요소가 입력되게 처리한다.
?sname=홍길동&kor=70&eng=80&math=90
		: 입력하고 submit 했을 때 - request.getParameter("sname").equals("홍길동")
 --%>
<%
...
// 문자열 형식으로된 숫자형문자열을 숫자로 변환.. : Interger.parseInt("25") ==> 25
// 실수 Double.parseDouble("25.7")
// 입력없이 submit를 누르면 넘어갈 때.
