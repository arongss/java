...
--%>
<%
	request.setAttribute("now", new Date()); // 오늘 날짜객체 생성
	request.setAttribute("num01", 798999.75); // 숫자데이터 설정
%>
<h2>날짜 format형식</h2>
<table>
	<col width="30%">
	<tr><th>기본형식</th><td><fmt:formatDate value="${now}"/></td></tr>
...
<table>
	...
	<tr><th>숫자패턴</th><td><fmt:formatNumber pattern="00,000,000,000.00" value="${num01}"/></td></tr>
</table>
