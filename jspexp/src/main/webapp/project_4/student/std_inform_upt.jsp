						...
						<div id="main-box2">
							<div>
								...
								<colgroup>
									...
									<tr><th>아이디(학번)</th>
										<td style="padding-left:10px;text-align:left;border:1px solid #D8D9DA;">${mem.id}
										<input type="hidden" name="id" value="${mem.id}"/></td></tr>
								...
								<input type="button" class="btn" id="bt" value="변경" onclick="uptIn(${mem.id});"/>
								</form>
							</div>
						</div>
					</div>
