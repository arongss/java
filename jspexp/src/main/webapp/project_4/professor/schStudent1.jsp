<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="jspexp.project_4.*"
	...
	<div>
		<div>
			<div class="flex-box1">
				...
				<div id="top-box2">
					<span id="tob-box2-span">${pro.proName} 교수</span> <span
			...
			<div class="flex-box2">
				...
				<div id="flex-box2_box2">
					...
					<jsp:useBean id="dao" class="jspexp.project_4.A01_schStudent" />
					<jsp:useBean id="sch" class="jspexp.project_4.vo.Student_p" />
								...
								<tbody>
									<c:forEach var="std" items="${dao.schStu(sch)}">
										<tr>
											...
											<td>${std.majorName}</td>
											<td>${std.stdYear}</td>
											<td><a onclick="inputGrade(${std.id})" class="entry"><span>입력/수정</span></a>
												<a onclick="delGrade(${std.id})" class="del"><span>삭
														제</span></a></td>
										</tr>
									</c:forEach>
								</tbody>
