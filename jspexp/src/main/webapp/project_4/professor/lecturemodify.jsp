               ...
               <div class="main-box-flex">
                  <div id="main-box1">
                     <div id="main-box1-iteam">
                        <span class="span-margin" id="span1">강의수정</span>
                     </div>
                     <div>
                        <span class="span-margin">강의관리 > 강의수정</span>
                     </div>
                  </div>
               </div>
                  ...
                  <div id="main-box2">
                     ...
                     <table id="addtable">
						 ...
						 <input type="text" readOnly value="${mem.id}" name="id"/>
                       	...
                       	<tr><td id="th">강의번호</td><td><input type="text" name="lecNum" placeholder="수정할 강의번호 입력"/></td></tr>
                     ...
                     <input type="button" id="bt" value="수정" onclick="ckValid()"/>
                     </form>
                     </div>
                  </div>
               </div>
