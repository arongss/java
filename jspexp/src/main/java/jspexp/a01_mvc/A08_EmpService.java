...
public class A08_EmpService {
	...
	public String empAjax(String ename, String job,
			String frSalS, String toSalS) {
	...
	public Emp getEmp(String ename, String job,
			String frSalS, String toSalS) {
		if(ename==null) ename = "";
		if(job==null) job = "";
	...
	public List<Emp> empList(String ename, String job,
			String frSalS, String toSalS){
		if(frSalS==null || frSalS.equals("")) frSalS = "0";
		if(toSalS==null || frSalS.equals("")) toSalS = "9999";
	...
	public List<Emp> empList(Emp sch){
		...
		if(sch.getFrSal()==0) sch.setFrSal(0);
