...
public class lectureVO {
	...
	public void setClass_I(int class_l) {
	...
	public lectureVO(int lecNum, String lecName, String lecLoc, String lecPlan, String lecYear, String semester,
			int grade, String times, String sort, int class_l, String id, int majorNo) {
		this.lecNum = lecNum;
	...
	public lectureVO(int lecNum, String lecName, String lecLoc, String lecYear, String semester, int grade, int majorNo,
			String times, String sort, String id, int class_l) {
		this.lecNum = lecNum;
		this.lecName = lecName;
		this.lecLoc = lecLoc;
		this.lecYear = lecYear;
	...
	public void seClass_l(int class_l) {
		this.class_l = class_l;
	}
