...
public class Student {
	...
	public Student(String address, String stdPhone, String stdEmail) {
		this.address = address;
		this.stdEmail = stdEmail;
		this.stdPhone = stdPhone;
	}

	public Student(String id, String stdName, int stdYear, int enterYear, String address, Date birthday,
	...
	public Student(String address, String stdPhone, String stdEmail, String id) {
		this.id = id;
		this.address = address;
		this.stdEmail = stdEmail;
		this.stdPhone = stdPhone;
