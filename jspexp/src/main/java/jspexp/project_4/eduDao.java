...
import jspexp.project_4.vo.lectureVO;
...
public class eduDao {
	...
	public void insertLecture(lectureVO in) {
		...
		try {
			...
			pstmt.setString(8, in.getTimes());
			pstmt.setString(9, in.getSort());
			pstmt.setInt(10, in.getClass_l());
			pstmt.setString(11, in.getId());
			pstmt.setInt(12, in.getMajorNo());
