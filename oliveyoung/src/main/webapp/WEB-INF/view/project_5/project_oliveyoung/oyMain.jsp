...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div style="margin-left:150px;" class="col-lg-4 col-4">
               ...
               <button class="btn btn-success" id="joinBtn" type="button">회원가입</button>
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-black font-weight-semi-bold mb-4">자극없이</h3>
                                    <h3 class="display-4 text-black font-weight-semi-bold mb-4">지우고</h3>
                                    <h3 class="display-4 text-black font-weight-semi-bold mb-4">새롭게 채우는</h3>
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">#1월의 태그박스를 만나보세요</h4>
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                ...
                                <h4 class="text-light text-uppercase font-weight-medium mb-3">유시몰</h4>
                                    <h3 class="display-4 text-black font-weight-semi-bold mb-4">새하얀</h3>
                                    <h3 class="display-4 text-black font-weight-semi-bold mb-4">미소를</h3>
                                    <h3 class="display-4 text-black font-weight-semi-bold mb-4">남겨드려요</h3>
                                    <h4 class="text-light text-uppercase text-font-weight-medium mb-3">최대 22%할인, 쿠폰</h4>
                                    <a href="#" class="btn btn-light py-2 px-3">Shop Now</a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-150 pb-3">
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    <h1 class="fa fa-check text-primary m-0 mr-3"></h1>
                    <h5 class="font-weight-semi-bold m-0">소중한 분에게 마음을 전해요!</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    <h1 class="fa fa-shipping-fast text-primary m-0 mr-2"></h1>
                    <h5 class="font-weight-semi-bold m-0">탑리뷰어 대상 할인쿠폰 지급!</h5>
                </div>
            </div>
    <!-- Featured End -->
    ...
    <!-- Offer Start -->
     <div class="container-fluid pt-5">
    <h2 class="text-center mb-4"><span class="px-2">Weekly Special</span></h2>
    <div class="container-fluid offer pt-5">
     ...
     <div class="container-fluid pt-5">
        <h2 class="text-center mb-4"><span class="px-2">인기 행사만 모았어요!</span></h2>
    <div class="container-fluid offer pt-5">
        <div class="row px-xl-5">
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
