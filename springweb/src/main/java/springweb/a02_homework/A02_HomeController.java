...
// springweb.a02_homework.A02_HomeController
...
*/
	...
	public String count(Counter cntOb) {
		return "WEB-INF\\views\\z01_homework\\a05_countUP.jsp";
	}
 ...
 */
	...
	public String records(Player p) {
		...
		return "WEB-INF\\views\\z01_homework\\a06_records.jsp";
	}
...
*/
	...
	public String login(Member m) {
		return "WEB-INF\\views\\z01_homework\\a08_mList.jsp";
	}
	...
	public String login(Member m, Model d) {
		...
		if(m.getId()==null) {
			page = "WEB-INF\\views\\z01_homework\\a07_login.jsp";
