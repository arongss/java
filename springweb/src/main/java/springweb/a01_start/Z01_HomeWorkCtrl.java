...
// springweb.a01_start.Z01_HomeWorkCtrl
...
//	*2) 아이디와 패스워드를 입력하여 인증 여부 모델로 설정하고 화면에 출력하세요(get/post 구분)
	...
	public String login90() {
		return "WEB-INF\\views\\z01_homework\\a01_loginFrm.jsp";
	}
 ...
 * 		grade, cnt, inRelpy, rGrade, rCnt (문제제출), msg(정답처리)
 ...
 * 		모델 데이터로 해당 값이 맞으면 정답 그렇지 않으면 오답이 되게 처리한다.
 ...
 */
	...
	public String gugu100(
		...
		return "WEB-INF\\views\\z01_homework\\a02_guguFrm.jsp";
	}
 ...
 */
	...
	public String game10(
		...
		return "WEB-INF\\views\\z01_homework\\a03_gameFrm.jsp";
	}
 ...
 */
	...
	public String kimbap(Kimbap kb) {
		if(kb.getPrice()>0) {
			kb.setCnt(kb.getCnt()+1);
			kb.setCnt(kb.getPrice()*kb.getCnt());
		}
		return "WEB-INF\\views\\z01_homework\\a04_kimbapFrm.jsp";
	}
